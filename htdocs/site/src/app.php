...
require_once __DIR__ . '/../src/webapp/extras/handlers.php';
...
try {
    ...
    $app->db = new PDO('sqlite:/home/gr11/apache/htdocs/site/app.db');   //TODO update with location of your database
